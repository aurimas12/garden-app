...
//   int _step = 0; // 0: intro+PHQ-9, 1: WHO-5, 2: Laisvalaikis-16, 3: done
//   int _phq9 = 0;
//   int _who5 = 0;
//   int _leis = 0;
...
// /// ——— Universalus klausimyno widget’as (viename puslapyje, be Scaffold)
...
//               backgroundColor:
//                   _complete ? widget.chipColor : Colors.grey.shade400,
//             ),
...
//   // Darbo (0–6) klausimai
//   final Map<int, int> _workLikert = {}; // 1..22
//   // Studentų (0–6) klausimai
//   final Map<int, int> _studentLikert = {}; // 1..16
//   bool _isStudent = false;

//   // Stresą keliantys įvykiai
...
//     'galiu_pasakyti_ne': -1,
//     // Miegas
//     'miego_kokybe': -1, // 5 lygiai
//     'atsibundu_pailsejes': -1, // 0=Ne, 1=Taip
//     // Įpročiai ir kt.
//     'fizinio_aktyvumo': -1, // 7 lygiai
//     'rukai': -1, // 0=Ne,1=Taip,2=Kita
//     'alkoholis': -1, // 5 lygiai
//     'tvarkausi_su_darbo_stresu': -1, // 0=Nepakankamai,1=Pakankamai
//     'isukiai': -1, // 5 lygiai
//     'gyvenimo_kontrole': -1, // 5 lygiai
//     'perf_tobulai': -1, // 5 lygiai
//     'perf_deleguoju': -1, // 5 lygiai
//     'perf_klaidu_baime': -1, // 5 lygiai
//     'perf_atleidziu_sau': -1, // 5 lygiai
//     'perf_atleidziu_kitiems': -1, // 5 lygiai
//     'vertingas_tik_dirbant': -1, // 5 lygiai
//     'socialinis_pasit': -1, // 5 lygiai
//   };

//   // Miegas (chip’ų indeksai)
//   int _miegoValandos = -1; // 0..7
//   int _uzmigimoTrukme = -1; // 0..3
//   int _einuiMiegoti = -1; // 0..6
...
//     required this.perdegimoPokytisText, // „sumažėjo“, „padidėjo“ arba „nepakito“
//   });

//   final int depresijaBuvo; // 0..27
//   final int depresijaDabar; // 0..27
//   final int nerimasBuvo; // 0..21
//   final int nerimasDabar; // 0..21
//   final int savijautaBuvo; // 0..25
//   final int savijautaDabar; // 0..25
//   final int atsistatymasBuvo; // 16..64
//   final int atsistatymasDabar; // 16..64
...
//   final VoidCallback? onNext; // jei nori, gali perduoti "Tęsti" veiksmą
...
// /// 1) Charakterio skalė — BE Scaffold
...
// /// 2) Rezultatų tekstas — BE Scaffold
