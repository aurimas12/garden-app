...
//     // Fiksuoto pločio etikečių stulpelis → visų blokų „label“ gražiai sulygiuoti
//     return Row(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         SizedBox(
...
//     // Jei eilutė prasideda „1)“, „2)“ ir pan. – rodom numeruotą sąrašą.
...
//     // Kitu atveju – paprasti taškiniai punktai
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         ...lines.map(
...
//   const MiegoHigienosPrincipaiPage({super.key});

//   @override
//   Widget build(BuildContext context) {
//     final theme = Theme.of(context).textTheme;

//     final List<String> taisykles = [
...
//         children: [
//           Text(
//             'Tad primenu svarbiausius dalykus:',
...
//   const MiegoIpareigojimasPage({super.key});
...
//               hintText: 'Įrašyk savo įsipareigojimą...',
...
//   const LinkiuGeroMiegoPage({super.key});
...
//       padding: const EdgeInsets.all(16),
//       child: Text(
//         'Linkiu tau šiąnakt gero miego ir iki kito susitikimo.',
//         style: theme.bodyLarge,
//         textAlign: TextAlign.justify,
//       ),
//     );
...
//   const LinkiuGeroMiegoPage1({super.key});
...
//   const KlausimaiApieMitybaPage({super.key});
...
//   const MitybosPokyciaiPage({super.key});
...
//             maxLines: 6,
//             decoration: InputDecoration(
//               hintText: 'Įrašyk savo mitybos pokyčius...',
//               border: OutlineInputBorder(
//                 borderRadius: BorderRadius.circular(8),
//               ),
//               contentPadding: const EdgeInsets.all(12),
...
//   const DemesingasValgymasPage({super.key});
...
//   const VandensSvarbaPage({super.key});
...
//   const KiekVandensReikiaPage({super.key});
...
//   const VandensUzdotisPage({super.key});
...
//   const SiltuLinkejimuPage({super.key});
...
//   const FizinisAktyvumasIvadasPage({super.key});
...
//   const FizinisAktyvumasKlausimaiPage({super.key});
...
//   const RaumenuRelaksacijaIntroPage({super.key});
...
//   const SportoMotyvacijaPage({super.key});
...
//   const IsbuvimoPraktikaPage({super.key});
...
//   const KunoSkenavimoPraktikaPage({super.key});
...
//           ),
//           const SizedBox(height: 12),
//           Text('• Ką patyriau praktikos metu?', style: theme.bodyLarge),
//           Text(
//             '• Kiek pavyko sekti vedančiosios balsą?',
//             style: theme.bodyLarge,
//           ),
//           Text('• Kokių minčių kilo praktikos metu?', style: theme.bodyLarge),
//           Text('• Ką jaučiu dabar?', style: theme.bodyLarge),
//           Text('• Ką dar pastebėjau?', style: theme.bodyLarge),
//           const SizedBox(height: 24),
//           if (onNext != null)
//             Center(
//               child: ElevatedButton(
